...
_ARG_PARSER = argparse.ArgumentParser(description="""
    ...
    under //analyzer/evaluator/treebank (make this directory if it does not
...
_ARG_PARSER.add_argument(
    ...
    help="""path to the directory which contains Turkish morphological"
    analyzer binary.""")
_ARG_PARSER.add_argument(
    "--treebank_dir",
    default="analyzer/evaluator/treebank",
...
def _gather_analyses(word_form, analyzer_dir):
  ...
  output = subprocess.check_output(
      ["./print_analyses", f"--word={word_form}"],
      cwd=analyzer_dir)
...
def _evaluate(word_forms, analyzer_dir):
  ...
  for word_form in word_forms:
    process_args = (word_form, analyzer_dir)
...
def main(args):
  ...
  statistics = _evaluate(word_forms, args.analyzer_dir)
