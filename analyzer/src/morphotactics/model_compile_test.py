...
"""Tests for analyzer.src.morphotactics.model_compile."""
...
_LEX_DIR = os.path.join("analyzer", "src", "lexicon", "testdata")
_MORPH_DIR = os.path.join("analyzer", "src", "morphotactics", "testdata")
