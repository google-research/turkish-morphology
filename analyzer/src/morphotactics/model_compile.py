...
from analyzer.src.lexicon import parser as lexicon_parser
from analyzer.src.lexicon import reader as lexicon_reader
from analyzer.src.lexicon import validator as lexicon_validator
from analyzer.src.morphotactics import common
from analyzer.src.morphotactics import parser as morphotactics_parser
from analyzer.src.morphotactics import reader as morphotactics_reader
from analyzer.src.morphotactics import rule_pb2
from analyzer.src.morphotactics import validator as morphotactics_validator
...
_ARG_PARSER = argparse.ArgumentParser(
    ...
    details, see the comments in //analyzer/build.sh.
