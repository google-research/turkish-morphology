...
function extract_morphophonemics() {
  ...
  # Grammars that are under //analyzer/src/morphophonemics implement the
...
function build_morphotactics() {
  ...
  #       //analyzer/src/symbols/base_symbols.syms. If you use a custom lexicon
  ...
  #       //analyzer/src/morphotactics/model_compile.py, and it is assumed that
  ...
  # //analyzer/src/morphotactics/model implement the inverse of the actual
...
function main() {
  ...
  readonly SRC_DIR=$BASE_DIR/analyzer/src
